---
title: "Walking the Seven Pilgrimage Churches of Rome"
description: "A route guide to Rome's seven pilgrimage basilicas — the Philip Neri circuit with distances, Metro shortcuts, and what to see at each church."
guideType: "walking"
citySlug: "rome"
faithTraditions:
  - "Christianity"
...
imageAlt: "The interior of one of Rome's great pilgrimage basilicas with golden mosaics and marble columns"
---
...
Walking the full circuit in a single day is possible but demanding. This guide provides the route in sequence with distances, transit options, and the essential details at each church. For Vatican logistics, dress codes, and transport passes, see our [Rome planning guide](/cities/rome/planning-your-rome-pilgrimage). For a multi-day approach, our [4-day itinerary](/cities/rome/4-days-in-rome) spreads the churches across three comfortable days.

## The Route at a Glance

The traditional sequence, with approximate distances between churches:

1. **St. Peter's Basilica** (Vatican) — Start
2. **St. Paul Outside the Walls** — 7.5km south
3. **San Sebastiano fuori le Mura** — 4km southeast
4. **St. John Lateran** — 5km north
5. **Santa Croce in Gerusalemme** — 1km east
6. **San Lorenzo fuori le Mura** — 2.5km north
7. **Santa Maria Maggiore** — 2km southwest — End

**Total distance**: approximately 22 kilometers on foot.
**Walking time**: 5-6 hours of pure walking, plus time inside each church.
**Full day estimate**: 8-10 hours including visits, rest, and a meal.
...
What not to miss: the **Holy Stairs (Scala Santa)** across the piazza — 28 marble steps that tradition holds were brought from Pilate's palace in [Jerusalem](/cities/jerusalem). Pilgrims ascend on their knees. The experience takes 15-20 minutes and is available regardless of whether you accept the historical claim. Also see the **cloister** (entry fee, Cosmatesque mosaic work from the thirteenth century) and the **papal altar**, which contains a wooden table traditionally identified as the altar on which Peter celebrated the earliest Roman eucharist.
